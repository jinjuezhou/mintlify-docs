        ...
        <div id="controls">
          ...
          <div style="display: flex; gap: 10px;">
            <input
              ...
              id="userInput"
              disabled=""
              placeholder="Type anything to communicate with the avatar..."
            />
...
<Note>
  {" "}
  Make sure the YOUR_BACK_END_API_FOR_START_SESSION return the paramsWithCredentials
  from your backend{" "}
</Note>
