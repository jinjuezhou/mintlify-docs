...
2. **For Video Face Detection**:
   ...
   - Specify the number of frames to analyze (default: 5)
...
- **Frame Selection**: For videos, choose `num_frames` based on video duration and required precision
...
response = requests.post(
    ...
    json={"url": image_url, "num_frames": 5},
