...
- **6-Point Landmarks**: Detects 6 key facial landmarks for each face
...
```json
{
  ...
  "faces_obj": {
    "0": {
      "landmarks": [
        [[294, 65], [316, 64], [304, 76], [305, 86], [296, 86], [314, 85]]
      ],
      "landmarks_str": [
        "294,65:316,64:304,76:305,86:296,86:314,85"
      ],
...
##### landmarks
- Type: `array`
- Array of 6-point landmarks for each detected face
- Format: `[[[x1, y1], [x2, y2], [x3, y3], [x4, y4], [x5, y5], [x6, y6]], ...]`
- Order: Left Eye, Right Eye, Nose, Mouth Center, Left Mouth Corner, Right Mouth Corner
- Note: The Mouth Center (4th point) is calculated as the midpoint of the X-axis between the mouth corners, while the Y-axis remains unchanged (aligned with the corners).

##### landmarks_str
- Type: `array`
- String representation of the landmarks
- Format: `["x1,y1:x2,y2:x3,y3:x4,y4:x5,y5:x6,y6"]`
- **For Face Swap API**: When using this for the `opts` parameter in Face Swap, only use the first 4 coordinate pairs (Left Eye, Right Eye, Nose, Mouth Center). Truncate the string after the 4th point (e.g., `x1,y1:x2,y2:x3,y3:x4,y4`).
...
```json
{
  ...
  "faces_obj": {
    "0": {
      "landmarks": [
        [[320, 240], [420, 240], [370, 300], [370, 350], [340, 350], [400, 350]],
        [[650, 220], [720, 220], [685, 270], [685, 310], [660, 310], [710, 310]]
      ],
      "landmarks_str": [
        "320,240:420,240:370,300:370,350:340,350:400,350",
        "650,220:720,220:685,270:685,310:660,310:710,310"
...
```json
{
  ...
  "faces_obj": {
    ...
    "10": {
      "landmarks": [
        [[325, 245], [425, 245], [375, 305], [375, 355], [345, 355], [405, 355]]
      ],
      "landmarks_str": [
        "325,245:425,245:375,305:375,355:345,355:405,355"
      ],
...
- **Note**: When using the landmarks for the Face Swap API (`opts` parameter), extract only the first 4 groups of coordinates from `landmarks_str` (Left Eye, Right Eye, Nose, Mouth Center).
