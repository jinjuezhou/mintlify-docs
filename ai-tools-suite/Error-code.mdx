...
| code          | 1214      | Streaming Avatar in processing  |
| code          | 1215      | Streaming Avatar processing is busy  |
| code          | 1216      | Streaming Avatar session not exist  |
| code          | 1217      | Streaming Avatar callback error  |
| code          | 1218      | Streaming Avatar processing error  |
| code          | 1219      | Streaming Avatar closed |
| code          | 1220      | Streaming Avatar upload avatar error  |
| code          | 1221      | Account not subscribed   |
| code          | 1222      | Resource already exist  |
| code          | 1223      | Streaming Avatar upload exceed  |
