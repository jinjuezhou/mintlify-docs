...
| supportedReference | Boolean | false    | Filter to only return models that support reference images. Default: false |
...
| supportedReference | Boolean | Whether the model supports reference images |
| maxImageCount | Integer  | Maximum number of reference images supported |
| batchQuantity | Array    | Supported batch quantities |
