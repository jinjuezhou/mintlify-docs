...
<Note>We restrict audio to 25MB.  we currently support .flac, .mp3, .mp4, .mpeg, .mpga, .m4a, .ogg, .wav, .webm</Note>
<Note>We restrict video to 1GB, resolution limited to 1080p. we currently support .mp4, .avi</Note>
