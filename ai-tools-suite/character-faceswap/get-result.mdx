...
description: "Retrieve character faceswap video results by ID"
---
...
|---------------|----------|--------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|
| video_model_id | String   | true         | The `_id` returned from the [Create Character Faceswap API](/ai-tools-suite/character-faceswap/create) |
...
```json
{
  ...
  "data": {
    ...
    "file_name": "CharacterFaceswap_1754362985482.mp4",
...
- Use the `_id` field from the [Create Character Faceswap API](/ai-tools-suite/character-faceswap/create) response as the `video_model_id` parameter
